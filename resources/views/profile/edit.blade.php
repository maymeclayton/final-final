...
<form action="/profile/{{$profile->profile_owner}}" method="post">
  @csrf
  @method('PUT')
  <div class="row">
    <div class="col">
...
<div class="form-group">
  ...
  <textarea class="form-control" id="lookingFor" rows="2" name="lookingFor">{{ $profile->lookingFor }}</textarea>
</div>

  <div class="form-group">
    <label for="biography">A little bit about me:</label>
    <textarea class="form-control" id="biography" rows="6" name="biography">{{ $profile->biography }}</textarea>
  </div>
